...
export default {
    ...
    mounted(){
        document.title = 'Checkout | djakects'

        this.cart = this.$store.state.cart


        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51K9JZVHE0KaiXh2gooPCqfTNWeB9ZJBu3hrnx5sbk7xLNlbeEgTNOUtkm49l4muCPQ1VMQwbWS0xQBXByuUzvb0q00aSCdDiuu')
